...
2. **AI 노드**: `ros2 run follower yolo_node --ros-args -p use_sim_time:=true`
3. **추종 노드**: `ros2 run follower follower_node --ros-args -p use_sim_time:=true`
4. **화면 모니터링**: `ros2 run rqt_image_view rqt_image_view` (토픽: `/yolo_result`)
